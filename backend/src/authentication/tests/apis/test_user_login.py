...
class UserSessionLoginTests(TestCase):
    ...
    def test_non_existing_user_cannot_login(self):
        ...
        data = {"username": "el@gmail.com", "email": "el@gmail.com", "password": "123456"}
    ...
    def test_existing_user_can_login_and_access_apis(self):
        ...
        credentials = {"username": "test@gmail.com", "password": "password"}
...
class UserJwtLoginTests(TestCase):
    def setUp(self):
        ...
        self.jwt_login_url = reverse("api:authentication:rest_login")
        self.jwt_logout_url = reverse("api:authentication:rest_logout")
        self.me_url = reverse("api:authentication:rest_user_details")
